...
#    print(var1, var2, var3)
    ...
    if((v1==1 or v1==2) and (v2==10 or v2==20)and (v3==100 or v3==200)):
       tk.messagebox.showinfo("Severity", "Severity = 1")
...
tk.Radiobutton(master, text='Drizzling without high winds', variable=var1, value=5).grid(row=4, column=1, sticky='W') 
tk.Radiobutton(master, text='Drizzling with high winds', variable=var1, value=6).grid(row=5, column=1, sticky='W')
...
tk.Radiobutton(master, text='Daylight: Street lights present and lit', variable=var3, value=200).grid(row=15, column=1, sticky='W')
